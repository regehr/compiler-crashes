...
system "$TEST_COMPILER_HOME/gcc-r222058-install/bin/g++ -o /dev/null -O2 -fstack-protector -Werror=format-security -Wall -fPIE -O3  -c small.cpp >/dev/null 2>&1";
if ($? != 0) {
...
system "rm -f out.txt";
my $err;
my $cmd = "$TEST_COMPILER_HOME/gcc-r224523-install/bin/g++ small.cpp ";
