...
system "$TEST_COMPILER_HOME/gcc-r172490-install/bin/g++ -o /dev/null -g -O2 --param=ssp-buffer-size=4 -Wformat -Werror=format-security -W -Wall -Werror=return-type -Wmissing-declarations -Winit-self -Wpointer-arith -Wshadow -Wno-narrowing -fdiagnostics-show-option -Wno-long-long -msse -msse2 -ffunction-sections -O2 -Werror=format-security  -c small.cpp >/dev/null 2>&1";
if ($? != 0) {
...
system "rm -f out.txt";
my $err;
my $cmd = "$TEST_COMPILER_HOME/gcc-r171467-install/bin/g++ small.cpp ";
