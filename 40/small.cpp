# 1 "../bin/xapian-tcpsrv.cc"
# 1 "../bin/xapian-tcpsrv.cc" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 120 "<built-in>" 3
# 120 "<command line>" 1
# 124 "<built-in>" 2
# 1 "../bin/xapian-tcpsrv.cc" 2
# 23 "../bin/xapian-tcpsrv.cc"
# 1 "./config.h" 1
# 24 "../bin/xapian-tcpsrv.cc" 2
...
# 26 "../bin/xapian-tcpsrv.cc" 2

# 1 "../common/safeerrno.h" 1
# 34 "../common/safeerrno.h"
...
# 35 "../common/safeerrno.h" 2
# 28 "../bin/xapian-tcpsrv.cc" 2
...
# 30 "../bin/xapian-tcpsrv.cc" 2


# 1 "../common/gnu_getopt.h" 1
# 27 "../common/gnu_getopt.h"
# 1 "/usr/include/c++/4.4/cctype" 1 3
# 41 "/usr/include/c++/4.4/cctype" 3
# 41 "/usr/include/c++/4.4/cctype" 3
# 28 "../common/gnu_getopt.h" 2



# 1 "/usr/include/gnu-versions.h" 1 3 4
# 32 "../common/gnu_getopt.h" 2
...
# 33 "../bin/xapian-tcpsrv.cc" 2

# 1 "../include/xapian/error.h" 1
# 26 "../include/xapian/error.h"
# 1 "../include/xapian/visibility.h" 1
# 23 "../include/xapian/visibility.h"
# 1 "./include/xapian/version.h" 1
# 24 "../include/xapian/visibility.h" 2
# 27 "../include/xapian/error.h" 2
...
# 35 "../bin/xapian-tcpsrv.cc" 2
# 1 "../common/remotetcpserver.h" 1
# 24 "../common/remotetcpserver.h"
# 1 "../common/tcpserver.h" 1
# 43 "../common/tcpserver.h"
class __attribute__((visibility("default"))) TcpServer {
...
# 25 "../common/remotetcpserver.h" 2

# 1 "../include/xapian/database.h" 1
...
# 30 "../include/xapian/database.h" 2

# 1 "../include/xapian/base.h" 1
# 27 "../include/xapian/base.h"
# 1 "../include/xapian/deprecated.h" 1
# 28 "../include/xapian/base.h" 2
...
# 32 "../include/xapian/database.h" 2
# 1 "../include/xapian/document.h" 1
# 31 "../include/xapian/document.h"
# 1 "../include/xapian/types.h" 1
...
# 32 "../include/xapian/document.h" 2
# 1 "../include/xapian/termiterator.h" 1
...
# 28 "../include/xapian/termiterator.h" 2



# 1 "../include/xapian/derefwrapper.h" 1
# 25 "../include/xapian/derefwrapper.h"
namespace Xapian {
...
# 32 "../include/xapian/termiterator.h" 2

# 1 "../include/xapian/positioniterator.h" 1
...
# 34 "../include/xapian/termiterator.h" 2
...
# 33 "../include/xapian/document.h" 2
# 1 "../include/xapian/valueiterator.h" 1
...
# 117 "../include/xapian/valueiterator.h"
    void skip_to(Xapian::docid docid_or_slot);
# 143 "../include/xapian/valueiterator.h"
    bool check(Xapian::docid docid);


    std::string get_description() const;
# 160 "../include/xapian/valueiterator.h"
    typedef std::input_iterator_tag iterator_category;
...
# 34 "../include/xapian/document.h" 2


namespace Xapian {
# 56 "../include/xapian/document.h"
class __attribute__((visibility("default"))) Document {
 ...
 ~Document();
# 95 "../include/xapian/document.h"
 std::string get_value(Xapian::valueno slot) const;
# 106 "../include/xapian/document.h"
...
# 250 "../include/xapian/document.h"
 docid get_docid() const;
# 259 "../include/xapian/document.h"
...
# 33 "../include/xapian/database.h" 2


# 1 "../include/xapian/postingiterator.h" 1
...
# 103 "../include/xapian/postingiterator.h"
...
# 131 "../include/xapian/database.h"
 void reopen();
# 167 "../include/xapian/database.h"
 virtual void close();


 virtual std::string get_description() const;
# 182 "../include/xapian/database.h"
...
# 266 "../include/xapian/database.h"
 bool term_exists(const std::string & tname) const;
# 277 "../include/xapian/database.h"
 Xapian::termcount get_collection_freq(const std::string & tname) const;
# 289 "../include/xapian/database.h"
 Xapian::doccount get_value_freq(Xapian::valueno slot) const;
# 301 "../include/xapian/database.h"
 std::string get_value_lower_bound(Xapian::valueno slot) const;
# 313 "../include/xapian/database.h"
...
# 433 "../include/xapian/database.h"
 std::string get_metadata(const std::string & key) const;
# 453 "../include/xapian/database.h"
...
class __attribute__((visibility("default"))) WritableDatabase : public Database {
    public:
# 493 "../include/xapian/database.h"
 virtual ~WritableDatabase();



 WritableDatabase();
# 521 "../include/xapian/database.h"
...
# 543 "../include/xapian/database.h"
 void operator=(const WritableDatabase &other);
# 583 "../include/xapian/database.h"
 void commit();
 ...
 void flush() { commit(); }
# 638 "../include/xapian/database.h"
 void begin_transaction(bool flushed=true);
# 665 "../include/xapian/database.h"
 void commit_transaction();
# 685 "../include/xapian/database.h"
 void cancel_transaction();
# 715 "../include/xapian/database.h"
 Xapian::docid add_document(const Xapian::Document & document);
# 738 "../include/xapian/database.h"
 void delete_document(Xapian::docid did);
# 759 "../include/xapian/database.h"
 void delete_document(const std::string & unique_term);
# 792 "../include/xapian/database.h"
 void replace_document(Xapian::docid did,
         const Xapian::Document & document);
# 828 "../include/xapian/database.h"
 Xapian::docid replace_document(const std::string & unique_term,
           const Xapian::Document & document);
# 838 "../include/xapian/database.h"
 void add_spelling(const std::string & word,
     Xapian::termcount freqinc = 1) const;
# 849 "../include/xapian/database.h"
...
# 27 "../common/remotetcpserver.h" 2
# 36 "../common/remotetcpserver.h"
class __attribute__((visibility("default"))) RemoteTcpServer : public TcpServer {
...
static void show_usage() {
    cout << "Usage: ""xapian-tcpsrv"" [OPTIONS] DATABASE_DIRECTORY...\n\n"
"Options:\n"
...
int main(int argc, char **argv) {
    ...
    int c;
    while ((c = gnu_getopt_long(argc, argv, opts, long_opts, __null)) != -1) {
 switch (c) {
     case 1:
  cout << "xapian-tcpsrv"" - ""TCP daemon for use with Xapian's remote backend""\n\n";
  show_usage();
  exit(0);
     case 2:
  cout << "xapian-tcpsrv"" - ""xapian-core 1.2.16" << endl;
  exit(0);
     case 'I':
                host.assign(optarg);
         break;
  ...
  syntax_error = true;
    ...
    if (syntax_error || argv[optind] == __null) {
 show_usage();
 exit(1);
    }
